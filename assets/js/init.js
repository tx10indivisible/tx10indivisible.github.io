		...
		plugins: {
			layers: {
				...
				titleBar: {
					breakpoints: 'narrower',
					height: 44,
					html: '<span class="toggle" data-action="toggleLayer" data-args="navPanel"></span><span class="title" data-action="copyHTML" data-args="logo"><img id="nav-logo" src="/assets/images/nav-logo.png" /></span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
